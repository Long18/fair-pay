-- Migration: Enhance public demo data with admin configuration
-- This allows the demo data to show more diverse debt information when admin email is configured

-- Drop the existing function
DROP FUNCTION IF EXISTS get_user_debts_public();

-- Create enhanced function that accepts admin email parameter
...
-- Also create a wrapper function for backward compatibility (no parameters)
...
AS $$
BEGIN
    RETURN QUERY SELECT * FROM get_user_debts_public(NULL);
END;
$$;
