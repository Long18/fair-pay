-- Migration: Update settle_split to insert payment events
-- Created: 2026-01-12
-- Purpose: Automatically create payment_events records when splits are settled
--
-- Related: Task 1.10 - Create payment/settlement events data pipeline
-- Requirements: 1.1 (Activity child rows need real data)

-- =============================================
-- Update settle_split function to insert payment events
-- =============================================
