-- Expand user_tracking_events CHECK so client/edge allowlist names persist.
-- Production still had the May 2026 allowlist; session_started (and later taxonomy
-- names) failed the constraint, which aborted the whole insert batch.
