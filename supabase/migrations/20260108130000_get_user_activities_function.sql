-- Migration: Add get_user_activities function for profile activity display
-- Created: 2026-01-08
...
-- Add comment
COMMENT ON FUNCTION get_user_activities(UUID, INTEGER) IS 'Get activities (expenses and splits) for a specific user with settlement status';
